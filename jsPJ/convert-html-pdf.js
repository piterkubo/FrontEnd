...
//part1:
    ...
    doc.fromHTML('<p>PITER KUBO CHAGAS, BRASIL,  residente e domiciliado(a) na cidade de São Paulo, Estado de SP, à</p>',15, 80);
    doc.fromHTML('<p>Rua da Quitanda, no 763, Bairro Centro, CEP 01009-111, portador(a) da carteira de identidade RG</p>',15, 85);
    doc.fromHTML('<p>no 04493209670, expedida pela SSPSP/SP,e do CPF no 123.456.789-00, doravante referido(a)</p>', 15, 90); 
...
//part17  
    doc.fromHTML('<p>Piter Kubo Chagas. "Assinado eletronicamente doc 123.456.789-00"</p>',15, 265);
