...
const pf_ddi = document.getElementById("pf_ddi")

window.addEventListener('load', async()=>{   
    
    const options = document.createElement("optgroup");
    options.setAttribute('label','Selecione o DDI');
    ddi.map((ddi)=>{
        options.innerHTML += '<option>'+[ddi.nome]+ '  - '+[ddi.fone]+'</option>'
    })            
        

    pf_ddi.append(options);

});


const pj_ddi = document.getElementById("pj_ddi")
